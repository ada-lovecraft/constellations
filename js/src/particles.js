...
var proton;
      ...
      function loadImage() {
        ...
        var logo = loader.addImage('img/constellation.png');
      ...
      function initBehaviours() {
        ...
        rect2 = new Proton.Rectangle(0, 0, window.innerWidth, window.innerHeight);
      ...
      function createProton() {
        ...
        stars = new Proton.Emitter();
        stars.rate = new Proton.Rate(1000, 1);
        stars.addInitialize(new Proton.Mass(1));
        stars.addInitialize(new Proton.Life(Infinity));
        stars.addBehaviour(new Proton.Alpha(new Proton.Span(0.25, 1.0)));
        stars.addBehaviour(new Proton.Color('#ffffff'));
        stars.addBehaviour(new Proton.Scale(new Proton.Span(0.2, 0.25)));
        stars.addInitialize(new Proton.P(new Proton.RectZone(0,0, drawCanvas.width, drawCanvas.height)));
        stars.emit('once');
        proton.addEmitter(stars);

        emitter = new Proton.Emitter();
        emitter.rate = new Proton.Rate(5, .1);
        ...
        emitter.addBehaviour(new Proton.Scale(new Proton.Span(0.1, 0.25)));
